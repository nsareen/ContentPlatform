    ...
    <>
      ...
      <div className="fixed inset-y-0 right-0 w-[450px] bg-white shadow-xl z-30 flex flex-col">
                ...
                {generatedImages.length > 0 ? (
                  ...
                  <div className="mt-6 p-4 border border-yellow-300 bg-yellow-50 rounded-md">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-sm">No images were generated. Check if the OpenAI API key is configured correctly.</p>
                    </div>
                  </div>
                )}
              </>
        ...
        <div className="border-t border-gray-200 p-4">
          <form onSubmit={(e) => { e.preventDefault(); handleGenerateContent(); }} className="flex flex-col space-y-4">
